...
urlpatterns = [
    path('content/create/container/done', views.CreateContainerDone.as_view(),name="create_container_done"),
    path('content/create/container', views.CreateContainer.as_view(),name="create_container"),
