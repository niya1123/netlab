# Generated by Django 3.0.2 on 2020-08-10 07:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relation_posts', models.ManyToManyField(blank=True, related_name='_contents_relation_posts_+', to='contents.Contents', verbose_name='関連記事')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contents.Contents', verbose_name='評価対象の本')),
            ],
        ),
        migrations.AddField(
            model_name='contents',
