# Generated by Django 3.0.2 on 2020-08-20 02:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choice_text', models.CharField(max_length=60, verbose_name='選択肢の文')),
                ('is_answer', models.BooleanField(default=False, verbose_name='正解文かどうか')),
            ],
        ),
        migrations.CreateModel(
            name='Content',
            fields=[
                ...
                ('question_description', models.TextField(verbose_name='問題の説明')),
                ('created_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='作成日')),
                ('updated_at', models.DateTimeField(default=django.utils.timezone.now, verbose_name='更新日')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('choice', models.ManyToManyField(to='contents.Choice', verbose_name='選択肢')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
