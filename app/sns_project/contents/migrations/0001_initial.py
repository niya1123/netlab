# Generated by Django 3.0.2 on 2020-10-15 05:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.CharField(choices=[('1', '選択肢1'), ('2', '選択肢2'), ('3', '選択肢3'), ('4', '選択肢4')], max_length=60, verbose_name='答え')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('response', models.CharField(max_length=60, verbose_name='回答')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='contents.Question')),
